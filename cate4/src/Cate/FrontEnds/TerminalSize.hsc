module FrontEnds.TerminalSize (getTerminalWindowSize) where

import Core.Types.CoreTypes (TerminalWindowSize(..))
...
getTerminalWindowSize = with (TerminalSizeStruct 0 0) $ \ts -> do
    ...
    return $ TerminalWindowSize (fromIntegral row) (fromIntegral (col-1))
